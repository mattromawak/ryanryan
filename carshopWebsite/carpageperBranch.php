...
require_once('./dataControllers/otherControllers/viewCustomers.php');
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Cars</title>
    <link rel="stylesheet" href="./css/carperpageBranch.css">
    ...
    <div class="clearfix">
        ...
        <div class="mainsectionCpprb"> <!-- Changed "mainsectionCpprb" to "mainSection" -->
            <div class="carlistTable">
                <?php require_once('./dataControllers/otherControllers/carperbranchDisplay.php') ?>
            </div>
        </div>
    </div>
</body>
